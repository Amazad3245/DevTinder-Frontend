        ...
        <footer className="flex flex-col md:flex-row bg-base-300 text-neutral-content items-center justify-around p-4 gap-4">
            ...
            <nav>
                <div className="grid grid-flow-col gap-4">
                    <a href="https://www.linkedin.com/in/mohammad-amazad-khan-545373179/" target="_blank" rel="noopener noreferrer">
                        <svg
                    ...
                    <a href="https://github.com/Amazad3245" target="_blank" rel="noopener noreferrer">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
